...
namespace AppendXRefsToAss
{
   ...
   public static class Loader
    ...
    /// <summary>
    /// Utility class to handle menus at global level.
    /// </summary>
    public class MenuUtilities
    {
        ...
        /// <summary>
        /// Note, this method is iterating all action tables and actions (for this plugin to also be able to find built-in actions).
        ...
        /// Of course you could also call the add/remove in other contexts and callbacks depending on the 3ds max state where 
        ...
        public static void SetupMenuHandlers()
        {
            ...
            // this will add it at startup and for some scenarios is enough. But a commercial app should consider above for workspace switching.
